...
! zion    = number of protons in isotope i
      ...
      character(100)  denstring


! set the mass fractions, z's and a's of the composition
! hydrogen, heliu, and carbon
      xmass(1) = 0.0d0 ; aion(1)  = 1.0d0  ; zion(1)  = 1.0d0
      xmass(2) = 1.0d0 ; aion(2)  = 4.0d0  ; zion(2)  = 2.0d0
      xmass(3) = 0.0d0 ; aion(3)  = 12.0d0 ; zion(3)  = 6.0d0
...
!      read (*,*) temp, den
      ...
      call get_command_argument(2,denstring)   !first, read in the two values
      read(tempstring,*) temp
      read(denstring,*) den
      temp_row(1) = temp !1.0d8 
      den_row(1)  = den  !1.0d6 
...
! end of pipeline loop
      ...
      enddo
      write(*,*) pep, etaele, xne, ener !Zach
      return
      end
